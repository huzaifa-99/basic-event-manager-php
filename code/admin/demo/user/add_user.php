...
<script src="../../assets/js/preloader.js"></script>
              ...
              <div class="mdc-layout-grid__cell--span-6">
                <div class="mdc-card">
                  ...
                  <div class="template-demo">
                    <form id="register-user-admin">
                    <div class="mdc-layout-grid__inner">
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
                          <input class="mdc-text-field__input" type="text" name="username_admin" id="text-field-hero-input1" required>
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                              <label for="text-field-hero-input1" class="mdc-floating-label">Name</label>
                            </div>
                            <div class="mdc-notched-outline__trailing"></div>
                          </div>
                        </div>
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
                          <input class="mdc-text-field__input" type="email" name="useremail_admin" id="text-field-hero-input2" required>
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                              <label for="text-field-hero-input2" class="mdc-floating-label">Email</label>
                            </div>
                            <div class="mdc-notched-outline__trailing"></div>
                          </div>
                        </div>
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined">
                          <input class="mdc-text-field__input" type="text" name="userpassword_admin" id="text-field-hero-input3" required>
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                              <label for="text-field-hero-input3" class="mdc-floating-label">Password</label>
                            </div>
                            <div class="mdc-notched-outline__trailing"></div>
                          </div>
                        </div>
                        ...
                        <div class="mdc-text-field mdc-text-field--outlined">
                          ...
                          <script type="text/javascript">
                            ...
                            function hide_label_show_inputTYPEfile(){
                              if(document.getElementById('text-field-hero-input4').value=="")
                              {
                                  // console.log("skcns");
                                  document.getElementById('text-field-hero-input4').style.display="none";
                                  document.getElementById('text-field-hero-input4').classList.remove("mdc-text-field__input");
                                  document.getElementById('label1').style.display="block";
                              }
                              else
                              {
                                  // console.log("bkscksb");
                                  document.getElementById('text-field-hero-input4').style.display="block";
                                  document.getElementById('text-field-hero-input4').classList.add("mdc-text-field__input");
                          ...
                          <label for="text-field-hero-input4" id="label1" class="form-control" style="text-align: left;padding-left: 1rem;color: grey;margin: auto;margin-left:1px; ">Profile Pic</label>
                          <input class="" type="file" name="userpic_admin" id="text-field-hero-input4" style="display:none;" oninput="return hide_label_show_inputTYPEfile()" required>
                    ...
                    <div class="mdc-text-field" data-mdc-auto-init="MDCSelect" style="background-color: white;border:1px solid #ddd;">
                      <input type="hidden" name="usertype_admin" required>
                      ...
                      <span class="mdc-floating-label">UserType</span>
                      <div class="mdc-line-ripple"></div>
                    </div>
                  </div>
                    </div>

                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop" style="float: right;">
                        <div class="mdc-text-field mdc-text-field--outlined">
                            <input type="submit" value="Register" class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12-desktop" name="" style="padding-left: 25px;padding-right: 25px;background-color: white;border:1px solid grey; color: grey;">
                        </div>
                    </div>
  ...
  <script type="text/javascript">
    ...
    // Signup Form Ajax Start
            ...
            document.getElementById('register-user-admin').setAttribute("action", "signup_php.php");
            document.getElementById('register-user-admin').setAttribute("method", "post");
            document.getElementById('register-user-admin').setAttribute("enctype", "multipart/form-data");
            // Must ______ For Signup Form end


            $("#register-user-admin").submit(function(e){
                e.preventDefault();
