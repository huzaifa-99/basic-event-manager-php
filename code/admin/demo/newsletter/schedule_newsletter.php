                ...
                <div class="mdc-card p-0">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      <thead>
                        <tr>
                          <th class="text-left">LetterId</th>
                          <th class="text-left">LetterBody</th>
                          <th class="text-left">Author Email</th>
                          <th class="text-left">Upload Time</th>
...
<?php
// Finding Users
$sqlqueryadmin16 = "SELECT * FROM mailing_letter WHERE Upload_Time!=Publish_Time /*AND Time_Accepted!==''*/";
$ressqlqueryadmin16 =mysqli_query($conn,$sqlqueryadmin16);
if($ressqlqueryadmin16){
  while($row=mysqli_fetch_array($ressqlqueryadmin16)){
    $letterid=$row['Id'];
   ...
   if($row['Status']==1){
    $action='<form action="" method="post" class="blocker">
              <input type="hidden" name="blockscheduled" value="'.$letterid.'">
              <input type="submit" class="btn btn-primary" name="Blocktoggle" value="Block">
            </form>';
    }
    elseif($row['Status']==0){
    $action='<form action="" method="post" class="unblocker">
              <input type="hidden"  name="unblockscheduled" value="'.$letterid.'">
              <input type="submit" class="btn btn-danger" name="UnBlocktoggle" value="Unblock">
            </form>'; 
    }
?>
                        <tr>
                          <td class="text-left"><?=$letterid?></td>
                          <td class="text-left"><?=$letterbody?></td>
                          <td class="text-left"><?=$author_email?></td>
                          <td class="text-left"><?=$upload_time?></td>
                          <td class="text-left"><?=$publish_time?></td>
    ...
    $(document).ready(function(){
      $('.blocker').submit(function(e){
        ...
        var data = new FormData(this);
          $.ajax({
              type: 'POST',
              url: 'schedule_newsletter_php.php',
              data: data,
              cache:false,
              contentType: false,
              processData: false,
              success: function (data) {
                if(data=='Could Not block scheduled Letter'){
                  alert(data);
                }
                else{
                  alert(data);
      ...
      $('.unblocker').submit(function(e){
        ...
        var data = new FormData(this);
          $.ajax({
              ...
              processData: false,
              success: function (data) {
                if(data=='Could Not unblock scheduled Letter'){
                  alert(data);
                }
                else{
                  alert(data);
