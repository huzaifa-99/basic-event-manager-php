                    ...
                    <table class="table table-hoverable">
                      <thead>
                        <tr>
                          ...
                          <th class="text-left"><div style="float: left;white-space: pre-line;">LetterBody</div></th>
                          <th class="text-left">Author Email</th>
                          <th class="text-left">Upload Time</th>
                          <th class="text-left">Publish Time</th>
                          
                          <!--<th>Sodium (mg)</th><th class="text-left">Status</th>
                          <th>Calcium (%)</th>
                          <th>Iron (%)</th>-->
                        </tr>
                      </thead>
...
<?php
// Finding Users
$sqlqueryadmin15 = "SELECT * FROM mailing_letter /*AND Time_Accepted!==''*/";
$ressqlqueryadmin15 =mysqli_query($conn,$sqlqueryadmin15);
if($ressqlqueryadmin15){
  while($row=mysqli_fetch_array($ressqlqueryadmin15)){
    $letterid=$row['Id'];
...
?>
                        <tr>
                          ...
                          <td class="text-left"><div style="float: left;white-space: pre-line;"><?=$letterbody?></div></td>
