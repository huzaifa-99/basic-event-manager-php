            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Block Pics</h6>
                  <div class="table-responsive">
                    <table class="table table-hoverable">
                      <thead>
                        <tr>
                          <th class="text-left">Id</th>
                          <th class="text-left">GalleryOf</th>
                          <th class="text-left">Image Name</th>
                          <th class="text-left">Activation Time</th>
...
if($ressqlqueryadmin6){
  while($row=mysqli_fetch_array($ressqlqueryadmin6)){
    ...
    if($row['Status']==1){
    $action='<form action="" method="post" class="blocker_pic">
              <input type="hidden" name="block" value="'.$pic_id.'">
              <input type="submit" class="btn btn-primary" name="Blocktoggle" value="Block">
            </form>';
    }
    elseif($row['Status']==0){
    $action='<form action="" method="post" class="unblocker_pic">
              <input type="hidden"  name="unblock" value="'.$pic_id.'">
              <input type="submit" class="btn btn-danger" name="UnBlocktoggle" value="Unblock">
            </form>';
    }
?>
                        <tr>
                          <td class="text-left"><?=$pic_id?></td>
                          <td class="text-left"><?=$gallery_of?></td>
                          <td class="text-left"><?=$image_name?></td>
                          <td class="text-left"><?=$active_time?></td>
...
?> 
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $('.blocker_pic').submit(function(e){
        e.preventDefault();
        var data = new FormData(this);
          $.ajax({
              type: 'POST',
              url: 'block_pics_php.php',
              data: data,
              cache:false,
              contentType: false,
              processData: false,
      ...
      $('.unblocker_pic').submit(function(e){
        e.preventDefault();
        var data = new FormData(this);
          $.ajax({
              type: 'POST',
