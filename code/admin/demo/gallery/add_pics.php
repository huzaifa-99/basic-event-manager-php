          ...
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell mdc-layout-grid__cell--span-12-desktop">
                <div class="mdc-card">
                  <h6 class="card-title">Upload Pics To Gallery</h6>

                  <form id="gallery_uploading_form" style="padding: 20px;padding-top: 50px;" enctype="multipart/form-data">
                    ...
                    <script type="text/javascript">
                          ...
                          <div class="mdc-layout-grid__inner">
                          <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12-desktop" style="margin-bottom: 10px;">
                            <div class="mdc-text-field mdc-text-field--outlined">
                              <label for="text-field-hero-input4" id="label1" class="form-control" style="text-align: left;padding-left: 1rem;color: grey;margin: auto;margin-left:1px;border:none; ">Image</label>
                              <input class="" type="file" name="gallerypicture" id="text-field-hero-input4" style="display:none;" oninput="return hide_label_show_inputTYPEfile()" style="text-align: left;padding-left: 1rem;color: grey;margin: auto;margin-left:1px;" required>
                              <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                    ...
                    <div class="mdc-text-field" data-mdc-auto-init="MDCSelect" style="background-color: white;border:1px solid #ddd;">
                      <input type="hidden" name="gallery_of" required>
                      ...
                      <div class="mdc-select__menu mdc-menu-surface demo-width-class">
                        <ul class="mdc-list">
                          ...
                          <li class="mdc-list-item" data-value="Trips">
                            Trips
                          </li>
                          <li class="mdc-list-item" data-value="Bussiness">
                            Bussiness
                          </li>
                          <li class="mdc-list-item" data-value="Opening Ceremony">
                            Opening Ceremony
                          </li>
                          <li class="mdc-list-item" data-value="Weddings">
                            Weddings
                          </li>
                          <li class="mdc-list-item" data-value="Birthdays">
                            Birthdays
                          </li>
                        </ul>
                      </div>
                      <span class="mdc-floating-label">Album</span>
                    ...
                    <input type="submit" name="create" style="margin-top: 20px;" class="btn btn-primary btn-block" value="Upload">
                  </form>
  ...
  <!--Convert Textarea To Ckeditor by name property Start-->         
    ...
    <script type="text/javascript">
      ...
      // Signup Form Ajax Start
            $("#gallery_uploading_form").submit(function(e){
                e.preventDefault();
                var data = new FormData(this);
                $.ajax({
                    type: 'POST',
                    url: 'add_pics_php.php',
                    data: data,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: function (data) {
                        if(data=='Uploaded to Database'){
                          alert(data);
                          $("#gallery_uploading_form")[0].reset();
                        }
                        else{
                          alert(data);
                        }
