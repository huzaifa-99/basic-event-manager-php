            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Active Reservations</h6>
...
<?php
// Finding Users
$sqlqueryadmin10 = "SELECT * FROM reservation WHERE Reservation_Status='1' AND Time_Completed='' /*AND Time_Accepted!==''*/";
...
if($ressqlqueryadmin10){
  while($row=mysqli_fetch_array($ressqlqueryadmin10)){
    ...
    $action='<form action="" method="post" class="reserver">
              <input type="hidden" name="idd" value="'.$id.'">
              <input type="hidden" name="timeposted" value="'.$time_posted.'">
              <input type="hidden" name="markcomplete" value="'.$email.'">
              <input type="submit" class="btn btn-primary" name="checkerbutton" value="Mask As Completed">
            </form>';
?>
                        <tr id="<?=$id?>">
        ...
        var data = new FormData(this);
          $.ajax({
              ...
              success: function (data) {
                if(data=='Could Not Mark Complete'){
                  alert(data);
                }
                else{
                  $("#"+data).hide('slow');
