            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Pending Reservations</h6>
...
<?php
// Finding Users
$sqlqueryadmin10 = "SELECT * FROM reservation WHERE Reservation_Status='0' /*AND Time_Accepted!==''*/";
...
if($ressqlqueryadmin10){
  while($row=mysqli_fetch_array($ressqlqueryadmin10)){
    ...
    $action='<form action="" method="post" class="reserver">
              ...
              <input type="hidden" name="markcheck" value="'.$email.'">
              <input type="submit" class="btn btn-primary" name="checkerbutton" value="Mask As Active">
            </form>';
?>
                        <tr id="<?=$id?>">
